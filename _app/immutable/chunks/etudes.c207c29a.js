import{A as e}from"./UIcon.e9759419.js";const t=[{degree:"Baccalauréat Générale - Maths SVT",description:"Le Lycée François Premier est un établissement d'enseignement secondaire situé à Fontainebleau. J'ai fréquenté ce lycée de 2020 à 2023, où j'ai suivi un cursus avec des spécialités en Sciences de l'Ingénieur (SI), en Sciences de la Vie et de la Terre (SVT) et en Mathématiques",location:"François 1er",logo:e.Francoispermier,name:"Lycée François Permier",organization:"ISTIC",period:{from:new Date(2020,0,1),to:new Date(2023,3,1)},shortDescription:"",slug:"francoispermier",subjects:["Mathématiques","SVT","SI"]},{degree:"BTS SIO SLAM",description:` # l'Utec en quelques mots
## Présentation
...
`,location:"UTEC Avon",logo:e.Utec,name:"UTEC Avon",organization:"UTEC Avon",period:{from:new Date(2023,4,9)},shortDescription:"",slug:"utecavon",subjects:["Java","HTML","CSS","Python","Debian"]}],i="Études";export{t as i,i as t};
